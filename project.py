...
def gconnect():
  ...
  gplus_id = credentials.id_taken['sub']
  ...
  if result['issued_to'] != CLIENT_ID:
    response = make_response(
      json.dumps("Token's client ID does not matcj app's."), 401)
  ...
  #store the userinfo and send to document
